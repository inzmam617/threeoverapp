...
class FilterThirdPage extends StatefulWidget {
  const FilterThirdPage({Key? key}) : super(key: key);

  @override
  State<FilterThirdPage> createState() => _FilterThirdPageState();
}

class _FilterThirdPageState extends State<FilterThirdPage> {
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            customstack("What am i looking for:"),
            const SizedBox(
              height: 10,
            ),
            customstack("My race is:"),
            const SizedBox(
              height: 10,
            ),
            customstack("My Ethnicity:"),
            const SizedBox(
              height: 10,
            ),
            customstack("My Body Type:"),
            const SizedBox(
              height: 10,
            ),
            customstack("My Political Beliefs:"),
            const SizedBox(
              height: 10,
            ),
            Stack(
                      ...
                      child: Container(
                        ...
                        child: Row(
                          ...
                          children:  const [
                            SizedBox(width: 10,),
                            Center(
                              child: Text("Am I vaccinated?",style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold),),
                            ),
                          ],
                        ),
                      ),
                                      ...
                                      child: Center(
                                        child: Row(
                                          ...
                                          children: [
                                            ...
                                            const Text("Part Time",style: TextStyle(color: Colors.white),),
                                            SizedBox(width:5),
                                            Container(
                                                width: 15,
                                                height: 15,
                      ...
                      child: Container(
                        ...
                        child: Row(
                          ...
                          children:  const [
                            SizedBox(width: 10,),
                            Center(
                              child: Text("Do I have Kids?",style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold),),
                            ),
                          ],
                        ),
                      ),
           ...
           customstack("My Education Level is"),
            const SizedBox(
              height: 10,
            ),
            customstack("My Financial situation:"),
            const SizedBox(
              height: 10,
            ),
            customstack("My Height:"),
            const SizedBox(
              height: 10,
            ),
            customstack("My relationship Status:"),
            const SizedBox(
              height: 10,
            ),
            customstack("My Religion is:"),
            const SizedBox(
              height: 10,
            ),
            customstack("What Do I Identity as?"),
            const SizedBox(height: 20,),
