...
import 'FIlterScreenThirdPage.dart';

class MatchingFilterSecondScreen extends StatefulWidget {
  const MatchingFilterSecondScreen({Key? key}) : super(key: key);

  @override
  State<MatchingFilterSecondScreen> createState() => _MatchingFilterSecondScreenState();
}

class _MatchingFilterSecondScreenState extends State<MatchingFilterSecondScreen> {
      ...
      body: SingleChildScrollView(
        child: Column(
          children:  [
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: ExpansionTile(
                        ...
                        title: const Text("",),
                        children: <Widget>[
                          redcustomstack("Secure attachment"),
                          redcustomstack("Anxious attachment"),
                          redcustomstack("Avoidant attachment"),
                          redcustomstack("Fearful-avoidant attachment"),
                        ],
                      ),
                    ),
                  ),
                    ...
                    child: Container(
                      ...
                      child: Row(
                        ...
                        children: const [
                          SizedBox(width: 10,),
                          Center(
                            child: Text("What is my match looking for?",style: TextStyle(color: Colors.white,fontSize:10),),
                          ),
                        ],
                      ),
                    ),
            ...
            customstack ("My Matches race should be:"),
            const SizedBox(
              height: 10,
            ),
            customstack ("My Matches Ethnicity should be"),
            const SizedBox(
              height: 10,
            ),
            customstack ("My Matches Body Type"),
            const SizedBox(
              height: 10,
            ),
            customstack ("My Matches Political Beliefs:"),
            const SizedBox(
              height: 10,
            ),
            Stack(
                                      ...
                                      child: Center(
                                        child: Row(
                                          ...
                                          children: [
                                            ...
                                            const Text("Don't Care",style: TextStyle(color: Colors.white),),
                                            SizedBox(width: 5,),
                                            Container(
                                                width: 15,
                                                height: 15,
                      ...
                      child: Container(
                        ...
                        child: Row(
                          ...
                          children:  const [
                            SizedBox(width: 10,),
                            Center(
                              child: Text("Am i vaccinated?",style: TextStyle(color: Colors.white,),),
                            ),
                      ...
                      child: Container(
                        ...
                        child: Row(
                          ...
                          children:  const [
                            SizedBox(width: 10,),
                            Center(
                              child: Text("Does my match have kids?",style: TextStyle(color: Colors.white,),),
                            ),
                      ...
                      child: Container(
                        ...
                        child: Row(
                          ...
                          children:  const [
                            SizedBox(width: 10,),
                            Center(
                              child: Text("Does my match want kids?",style: TextStyle(color: Colors.white,),),
                            ),
