      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: ExpansionTile(
                        ...
                        title: const Text("",),
                        children: <Widget>[
                          redCustomStack("High School"),
                          redCustomStack("College"),
                          redCustomStack("University"),
                          redCustomStack("Phd"),
                    ...
                    child: Container(
                      ...
                      child: Row(
                        ...
                        children: const [
                          SizedBox(width: 10,),
                          Center(
                            child: Text("My Matches Education Level is",style: TextStyle(color: Colors.white,fontSize:10),),
                          ),
                        ],
                      ),
                    ),
            ...
            customStack("My Matches Financial situation is:"),
            const SizedBox(
              height: 10,
            ),
            customStack("My Matches Height should be:"),
            const SizedBox(
              height: 10,
            ),
            ...
            customStack("My Matches relationships Status:"),
            const SizedBox(
              height: 10,
            ),
            customStack("What does my Match identify as:"),
            const SizedBox(
              height: 10,
            ),
                      ...
                      child: Container(
                        ...
                        child: Row(
                          ...
                          children:  [
                            ...
                            Center(
                              child: Text("My Matches Religion should be:",style: TextStyle(color: Colors.white,fontSize: 10,),
                              ),)
                          ],
                        ),
                      ),
